...
const CACHE = "ch-shell-v86"; // v86: C3 lightbox pan/close + A2 no-feed-refresh-on-triage + P3 relay icon-only + C2 lightbox pinch/wheel zoom + B4 hold-to-preview peek
const SHELL = [
  "/",
  "/triage",
