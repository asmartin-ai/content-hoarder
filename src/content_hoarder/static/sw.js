...
const CACHE = "ch-shell-v92"; // v92: T3 mobile-polish batch — drop reader dock + relay swipe-close + peek flicker + tag-suggest-3 + lightbox swipe-scroll + sidebar scroll-lock
const SHELL = [
  "/",
  "/triage",
