...
1. **Reddit** — The connector can read your existing `/path/to/reddit-saved-manager/data/app.db`
...
`/path/to/reddit-saved-manager/data/app.db` — 64,615 rows, all with fullname/permalink/subreddit/score, so
...
1. **Reddit import:** OK to run `content_hoarder import "/path/to/reddit-saved-manager/data/app.db"` against a
